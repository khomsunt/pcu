...
?>
<div>
    <canvas id="myChart01-5"></canvas>
</div>

<script>
var rows = <?php echo json_encode($rows); ?>;

new Chart($("#myChart01-5"), {
    ...
    data: {
        ...
        datasets: [{
            ...
            borderWidth: 1,
            backgroundColor: rows.map(row => row.avg_percent_moph_color),
            borderColor: rows.map(row=>row.avg_percent_moph_border_color),
        }]
    },
    options: {
        scales: {
