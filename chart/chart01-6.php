...
?>
<div>
    <canvas id="myChart01-6"></canvas>
</div>

<script>
var rows = <?php echo json_encode($rows); ?>;

new Chart($("#myChart01-6"), {
    ...
    data: {
        ...
        datasets: [{
            ...
            borderWidth: 1,
            backgroundColor: rows.map(row => row.avg_percent_pao_color),
            borderColor: rows.map(row=>row.avg_percent_pao_border_color),
        }]
    },
    options: {
        scales: {
